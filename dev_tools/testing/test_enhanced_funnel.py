...
sys.path.append('/mnt/c/Projects/land-acquisition-pipeline')
...
def test_quality_distribution():
    ...
    try:
        ...
        sample_validation_data = pd.DataFrame({
            'Address_Confidence': ['ULTRA_HIGH', 'ULTRA_HIGH', 'ULTRA_HIGH', 'ULTRA_HIGH',
                                 'HIGH', 
                                 'MEDIUM'] * 3 + ['MEDIUM', 'LOW', 'LOW', 'LOW', 'LOW', 'LOW'],
